...
export const Hero = ()=>{
    ...
    <div onClick={handleMiniNextClick} className="origin-center scale-50 opacity-0 transition-all duration-500 ease-in hover:scale-100 hover:opacity-100 ">
    ...
    <div className="absolute z-40 left-0 top-0 size-full">
        <div className="mt-24 px-5 sm:px-10">
          ...
          <p className="font-robert-regular mb-5 max-w-64 text-blue-75"> Enter a Metagame Layer <br /> Unleash the Play Economy</p>
