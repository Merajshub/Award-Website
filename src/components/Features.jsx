...
const BentoTilt = ({children, className = ''})=>{
    ...
    const handleMouseMove = (e)=>{
        ...
        const titleX = (relativeY - 0.5)*5;
        const titleY = (relativeX - 0.5)*-5;

        const newTransform = `perspective(700px) rotateX(${titleX}deg) rotateY(${titleY}deg) scale3d(0.98,0.98,0.98)`
    ...
    return  (
        <section className="bg-black pb-52">
            ...
            <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
                ...
                <BentoTilt className="bento-tilt_1 row-span-1 ms-54 md:col-span-1 md: ms-0">
                 <BentoCard 
